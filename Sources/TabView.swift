...
internal class TabView: UIView {
    ...
    init(option: TabPageOption) {
        ...
        let topCollection = NSLayoutConstraint(item: currentBarView,
                                     attribute: .top,
                                     relatedBy: .equal,
        ...
        let leftCollection = NSLayoutConstraint(item: currentBarView,
                                      attribute: .leading,
                                      relatedBy: .equal,
                                      toItem: collectionView,
                                      attribute: .leading,
                                      multiplier: 1.0,
                                      constant: 0.0)
        currentBarViewLeftConstraint = leftCollection
        collectionView.addConstraints([topCollection, leftCollection])
    }
